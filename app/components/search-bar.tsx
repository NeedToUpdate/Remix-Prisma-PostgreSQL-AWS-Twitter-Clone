...
export function SearchBar() {
  ...
  return (
    <form className="w-full px-6 flex justify-center items-center gap-x-4 border-b-4 border-b-blue-900 border-opacity-30 h-fit flex-wrap">
      ...
      <div className="flex gap-1 items-center justify-center">
        ...
        {searchParams.get("filter") && (
          <button onClick={clearFilters} className="rounded-md bg-red-300 font-semibold text-blue-600 px-3 py-2 transition duration-300 ease-in-out hover:bg-yellow-400 hover:-translate-y-1">
            Clear Filters
          </button>
        )}
      </div>
